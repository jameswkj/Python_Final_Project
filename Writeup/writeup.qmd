...
**Respective Sections:** KJ:Education parts/ Carey Cui:Age parts/ XiaoTian Tang: States parts

**Github usernames:** KJ(jameswkj) / Carey Cui(CUI19999) / XiaoTian Tang(xiaotiantangishere)
```{python}
%reset -f
import pandas as pd
...
#import data
# os.chdir('/Users/Kaijie/Desktop/Python II Final Project')
# age_df = pd.read_csv('Education/CPS_Demographic_Turnout_Rates_v1.0.csv')
